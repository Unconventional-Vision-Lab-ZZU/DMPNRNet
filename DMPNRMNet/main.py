...
from models.DMPNRMNet import build_net
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='DMPNRMNet', type=str)
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='results/DMPNRMNet/weights/model_100.pkl')
